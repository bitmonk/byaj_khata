...
class AppTextConfirmPassword extends StatefulWidget {
  const AppTextConfirmPassword({
    super.key,
    this.validator,
    this.hintText,
    this.prefixIcon,
  ...
  @override
  State<AppTextConfirmPassword> createState() => _AppTextConfirmPasswordState();
}

class _AppTextConfirmPasswordState extends State<AppTextConfirmPassword> {
  // bool hasInteracted = false;
  bool hasError = false;
  // bool isFocused = false;

  @override
  void didUpdateWidget(covariant AppTextConfirmPassword oldWidget) {
  ...
  TextStyle? _getLabelStyle(BuildContext context) {
    ...
    // if (hasValidationError && currentValue.isNotEmpty) {
